...
<base href="./">
    ...
    <link href="src/pace.css" rel="stylesheet">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    ...
    <div class="app-body">
      ...
      <main class="main">
    	...
    	<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Campaign Subject">
  		</div>
  		 <div class="form-group">
    	<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Send To">
  		</div> 
  		 <div class="form-group">
    	<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Select Group">
  		</div> 
  		<p class="text-right"> 
  		<a href=# >Advance Options</a></p>
  		</div>
				...
				<div class="row">
					<div class="col col-8">
						...
						<div class="jumbotron" style="background-color: #fff !important;">
							<h1 class="display-4">Hello, Members!</h1>
